...
public class WitheredBoneItem extends IntroToGraphicArtDimensionModElements.ModElement {
	@ObjectHolder("intro_to_graphic_art_dimension:withered_bone")
	public static final Item block = null;
	public WitheredBoneItem(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 1);
	}
