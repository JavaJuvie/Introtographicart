...
public class SmallShadowTreeStructure extends IntroToGraphicArtDimensionModElements.ModElement {
	public SmallShadowTreeStructure(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 39);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("intro_to_graphic_art_dimension", "smallshadowtree"));
						if (template == null)
							return false;
