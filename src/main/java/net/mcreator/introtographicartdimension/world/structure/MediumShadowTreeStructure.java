...
package net.mcreator.introtographicartdimension.world.structure;
...
public class MediumShadowTreeStructure extends IntroToGraphicArtDimensionModElements.ModElement {
	public MediumShadowTreeStructure(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 42);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 999999) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("intro_to_graphic_art_dimension", "mediumshadowtree"));
						if (template == null)
							return false;
