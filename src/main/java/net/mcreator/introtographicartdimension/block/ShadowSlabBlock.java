...
public class ShadowSlabBlock extends IntroToGraphicArtDimensionModElements.ModElement {
	@ObjectHolder("intro_to_graphic_art_dimension:shadow_slab")
	public static final Block block = null;
	public ShadowSlabBlock(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 13);
	}
