...
public class PrimeBulletBlock extends IntroToGraphicArtDimensionModElements.ModElement {
	@ObjectHolder("intro_to_graphic_art_dimension:prime_bullet")
	public static final Block block = null;
	public PrimeBulletBlock(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 65);
	}
