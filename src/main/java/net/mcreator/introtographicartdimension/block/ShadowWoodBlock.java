...
public class ShadowWoodBlock extends IntroToGraphicArtDimensionModElements.ModElement {
	@ObjectHolder("intro_to_graphic_art_dimension:shadow_wood")
	public static final Block block = null;
	public ShadowWoodBlock(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 8);
	}
