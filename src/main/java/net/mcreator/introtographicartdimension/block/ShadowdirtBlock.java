...
public class ShadowdirtBlock extends IntroToGraphicArtDimensionModElements.ModElement {
	@ObjectHolder("intro_to_graphic_art_dimension:shadowdirt")
	public static final Block block = null;
	public ShadowdirtBlock(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 4);
	}
