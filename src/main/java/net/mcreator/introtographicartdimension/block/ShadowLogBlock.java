...
public class ShadowLogBlock extends IntroToGraphicArtDimensionModElements.ModElement {
	@ObjectHolder("intro_to_graphic_art_dimension:shadow_log")
	public static final Block block = null;
	public ShadowLogBlock(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 9);
	}
