...
public class ShadowFenceBlock extends IntroToGraphicArtDimensionModElements.ModElement {
	@ObjectHolder("intro_to_graphic_art_dimension:shadow_fence")
	public static final Block block = null;
	public ShadowFenceBlock(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 14);
	}
