...
public class ShadowStairsBlock extends IntroToGraphicArtDimensionModElements.ModElement {
	@ObjectHolder("intro_to_graphic_art_dimension:shadow_stairs")
	public static final Block block = null;
	public ShadowStairsBlock(IntroToGraphicArtDimensionModElements instance) {
		super(instance, 12);
	}
